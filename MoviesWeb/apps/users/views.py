...
from apps.users import serializers # Modificado para importar el serializador de la app users
...
class LoginView(generics.CreateAPIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            response = Response({'message': 'Login successful'}, status=status.HTTP_201_CREATED)
